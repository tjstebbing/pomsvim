...
hi LineNr                  gui=underline   guifg=#855060 guibg=#FFC9F2
hi VertSplit               gui=underline   guifg=bg      guibg=#FFC9F2
hi StatusLine              gui=underline   guifg=fg      guibg=#FFC9F2
hi StatusLineNC            gui=underline   guifg=#3c2c31 guibg=#FFC9F2
hi NonText                 gui=underline   guifg=#FFF3FE 
hi NonText                                 guibg=#FFF3FE 
" title
...
" inner {{{1
hi Normal                  gui=none        guifg=#46284C guibg=#FFF3FE
...
hi Special                 gui=none        guifg=#65396D guibg=bg   
hi SpecialKey              gui=none        guifg=#cca966 guibg=bg   
hi Identifier              gui=none        guifg=#65396D guibg=bg   
