...
if has("gui_running")
    hi Normal         gui=NONE   guifg=#ffffff   guibg=#1e1e27
    ...
    hi String         gui=NONE   guifg=#abcabc   guibg=#1e1e27
    hi Error          gui=NONE   guifg=#ffffff   guibg=#ff0000
    hi Identifier     gui=NONE   guifg=#ff9100   guibg=NONE
    ...
    hi Type           gui=NONE   guifg=#ff9100   guibg=NONE
