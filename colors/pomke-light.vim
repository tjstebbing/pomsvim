...
hi NonText                 gui=underline   guifg=#ffffff guibg=#ffffff
...
hi WarningMsg              gui=underline   guifg=bg      guibg=#ffffff
hi ModeMsg                 gui=underline   guifg=bg      guibg=#7c3399   


"TODO
" inner {{{1
hi Normal                  gui=none        guifg=#9388bb guibg=#dddddd
hi Ignore                  gui=none        guifg=bg      guibg=bg   
hi Todo                    gui=underline   guifg=bg      guibg=#ffffff
hi Error                   gui=underline   guifg=fg      guibg=#ffffff
