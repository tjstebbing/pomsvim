...
" GUI Color Scheme
hi Normal       gui=NONE     guifg=White   guibg=#17191B
hi NonText      gui=NONE     guifg=#ff9999 guibg=#444444
hi Function     gui=NONE     guifg=#7788ff guibg=#17191B
hi Statement    gui=BOLD     guifg=Yellow  guibg=#17191B
hi Special      gui=NONE     guifg=Cyan    guibg=#17191B
hi Constant     gui=NONE     guifg=#ff9900 guibg=#17191B
hi Comment      gui=NONE     guifg=#777777 guibg=#17191B
hi Preproc      gui=NONE     guifg=#33ff66 guibg=#17191B
hi Type         gui=NONE     guifg=#ff5577 guibg=#17191B
hi Identifier   gui=NONE     guifg=Cyan    guibg=#17191B
hi StatusLine   gui=BOLD     guifg=White   guibg=#333333
hi StatusLineNC gui=NONE     guifg=Black   guibg=#333333
...
hi Directory    gui=NONE     guifg=Green   guibg=#17191B
...
hi Question     gui=NONE     guifg=#66ff99 guibg=#17191B
